...
(	
	...
	reserve3 varchar(500)                  comment '备用字段3',
	reserve4 varchar(500)                  comment '备用字段4'
)  distributed by range (accno) ( 
    g1 values less than ('6214680025000001'), 
	g2 values less than ('6214680050000001'), 
	g3 values less than ('6214680075000001'), 
    g4 values less than maxvalue) ;
create index account_idx1 on bank.account (cuno) ;
...
)distributed by hash(debitacc)(g1,g2,g3,g4);	
